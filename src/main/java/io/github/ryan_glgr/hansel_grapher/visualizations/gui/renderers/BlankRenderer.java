...
public class BlankRenderer implements GLEventListener {
    private static final String DEFAULT_IMAGE = "daisy.jpg";
    private static final String DEFAULT_IMAGE_PATH = "resources" + File.separator + DEFAULT_IMAGE;
